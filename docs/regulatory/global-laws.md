...
| Manifest disclosure in content | Manifest label (`AI-GENERATED CONTENT`) recorded per call in the watermark log | The API response carries no disclosure field: show the end-user notice in your own UI |
...
|---|---|
| Mark AI-generated content | Latent watermark + logged manifest label |
...
| Transparency | Logged manifest label; end-user notice in the deployer's UI |
...
| Watermark/label AI-generated content | Latent watermark + logged manifest label |
...
| Disclosure to job candidates | Deployer's notice; latent watermark for provenance |
